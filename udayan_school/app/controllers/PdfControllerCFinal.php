...
class PdfControllerCFinal extends \BaseController {
        ...
        <table  style="border-collapse: collapse;letter-spacing: 1px;width: 100%;font:arial" border="1" >
           ...
           <tr style="text-align: center" >
            ...
            $res = TStudentResult::where('st_id',$s->student_idstudentinfo)->where('academic_year',$year)
                                 ->where('t_st_result.subjectid','!=','25')->where('t_st_result.subjectid','!=','31')
            ...
            foreach ($res as $result) {
             ...
             //       $mx = TStudentResult::where('idclasssection',$cls->class_id)->where('term',$term)->where('subjectid',$result->subjectid)->max('gt_total');
...
/***************************************************** FOR AGRICULTURE ***************************************************/
 ...
 ';
     ...
     /********************************************* FOR RELIGION *******************************************/
            ...
            $total_m = $total_m + $result->f_total;

            $avg_grd = $avg_grd + $result->f_gp;
