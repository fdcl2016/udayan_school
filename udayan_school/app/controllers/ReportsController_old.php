...
*/
    ...
    public function getStudentReportCard() {
        ...
        /* download link */
        (count(Session::get('show_download_link')) ? $show_download_link = Session::get('show_download_link') : $show_download_link = Session::get('show_download_link'));
        ...
        return View::make('result_management.student_report_card')
            ...
            ->with('term12',$term)
            ->with('msg', $msg)
            ->with('show_download_link', $show_download_link);
    }
