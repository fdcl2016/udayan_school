...
<div style="margin-left: auto;margin-right: auto;width: 960px;background-color: ">
    ...
    <div style="width: 750px;float: left;text-align: center" >
        <p style="font-size: 30px;font-weight: bold"><?php echo Config::get('schoolname.school');?></p>
        <p>
...
<div style="margin-left: auto;background-color: ;margin-right: auto;width: 960px;">
    ...
    <div style="width: 600px;float: left;margin-left: 3px;margin-top: 25px">
        ...
        <table >
            ...
            <tr>
                ...
                <td height="25"><b>Name :</b> &nbsp;&nbsp;&nbsp;{{$sn}}</td>

            </tr>

            <tr>

                <td height="25"><b>Class :</b> &nbsp;&nbsp;&nbsp;{{$s->class}}&nbsp;&nbsp;&nbsp;<b>Section :</b> &nbsp;&nbsp;&nbsp;{{$s->section}}</td>

            </tr>
            <tr>

                <td height="25"><b>Roll :</b> {{$s->st_roll}}&nbsp;&nbsp;<b>Student ID :</b> &nbsp;&nbsp;{{$idstudent}}</td>
            ...
            <tr>
                ...
                ?>
                <td height="25"><b>Version :</b> &nbsp;&nbsp;&nbsp;{{$v}}&nbsp;&nbsp;&nbsp;<b> Year :</b> &nbsp;&nbsp;&nbsp;{{$year}}&nbsp;&nbsp;&nbsp;<b>Term :</b> &nbsp;&nbsp;&nbsp;{{$term}}</td>
    ...
    <h3 style="margin-top: 15px;margin-right: 150px"><br/>OBTAINED MARK<hr/></h3>
        ...
        <table style="border-collapse: collapse;letter-spacing: 1px;width: 100%;" border="1" >
            ...
            <tr>
                <td>&nbsp;&nbsp;<b>Grade Point Average (GPA</b>)</td><td style="text-align: center"> <?php
                    ...
                    ?></td><td style="text-align: center"><b>Merit Position</b></td><td colspan="2" style="text-align: center">Attendance</td>

            </tr>

            <tr>
                <td>&nbsp;&nbsp;Letter Grade</td><td style="text-align: center">{{$st_rank->grade}}</td><td rowspan="2" style="text-align: center">{{$st_rank->rank}}</td><td style="text-align: center">Working Days</td><td style="text-align: center">N/A</td>

            </tr>

            <tr>
                <td>&nbsp;&nbsp;Total Marks</td><td style="text-align: center;font-weight: bold">{{$st_rank->total_mark}}</td><td style="text-align: center" >Attendance</td><td style="text-align: center">N/A</td>
