...
<div style="margin-left: auto;background-color: #fff8dc;margin-right: auto;width: 960px;">
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 560px;background-color: #fff8dc;padding: 15px">
                <table style="text-align: center;;background-color: #d8e4bc;border-collapse: collapse;background-color: #d8e4bc" border="1">

                    <tr >
                        <td width="200px"><h3>Name</h3></td> <td  width="660px" style="letter-spacing: 3px;padding-left: 5px"><b>{{$sn}}</b></td>

                    </tr>


                    <tr>
                        <td width="200px"><h3>Class</h3></td> <td  width="660px" style="padding-left: 5px">{{$s->class}}</td>

                    </tr>

                    <tr>
                        <td width="200px"><h3>Section</h3></td> <td  width="660px" style="padding-left: 5px">{{$s->section}}</td>

                    </tr>

                    <tr>
                        <td width="200px"><h3>Class Roll</h3></td> <td  width="660px" style="padding-left: 5px" >{{$s->st_roll}}</td>

                    </tr>

                    <tr>
                        <td width="200px"><h3>Student ID</h3></td> <td  width="660px" style="padding-left: 5px" >{{$idstudent}}</td>

                    </tr>


                    <tr>
                        <td width="200px"><h3>Session</h3></td> <td  width="660px" style="padding-left: 5px">{{$s->year}}</td>

                    </tr>

                    <tr>
                        <td width="200px" ><h3>Version</h3></td>
            ...
            <td  style="width: 400px;background-color:#fff8dc ;padding-left: 35px;padding-right: 10px">
                <table style="text-align: center;background-color:#f2dcdb;border-collapse: collapse;" border="1">
        ...
        <tr>
            <td style="width: 600px;padding: 10px">
                <table style="text-align: center;background-color: #f2f2f2;">
                    <thead>
                    <tr>
                        <th width="360" style="text-align: left;border:1px solid">Subject Name</th>
                        <th width="100" style="border:1px solid">Total Marks</th>
                        <th width="100" style="border:1px solid">Obtain Marks</th>
                        <th width="100" style="border:1px solid">Grade</th>
                        <th width="100" style="border:1px solid">GPA</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr >
                        ...
                        <td style="border: 1px solid">Total :<?//php echo $sum?></td>
            ...
            <td  style="width: 400px;padding-left: 30px">
                <table width="300px;background-color: #e4dfec">

                    <tbody style="background-color: #e4dfec;margin-left: 5px">
                    <tr >
                        <td></td>
                        <td>Rank</td>
                        <td>:</td>
