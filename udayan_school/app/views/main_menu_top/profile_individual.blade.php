    ...
    <div class="span12">
        ...
        <div class="widget ">
            ...
            <div class="widget-header">
                ...
                <h3>Profile of {{$profile->teacher_name}}</h3>
            </div>
                ...
                <div class="tabbable">
                    @if($profile!=""&&Auth::user()->type=="admin")
                        <div class="fdcl_content_profile">
                            ...
                            <div class="tab-content widget-content">
                                ...
                                <div class="col-sm-10">
                                    <div class="span8"><b>Mother's Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> {{$profile->mother_name}} </div>
                    ...
                    @if($profile!=""&&Auth::user()->type=="teacher")
                         <div class="fdcl_content_profile">
                            ...
                            <center>
                                            <h3>{{$profile->teacher_name}}</h3>
                                            <h4>{{$profile->personal_mobile}}</h4>
                                            <h4>{{$profile->email}}</h4></div><br><br>
                            </center>

                            <center>
                                    @if($profile->image!=null)
                                        <img src="{{ URL::asset('/uploads/'.$profile->image)}}" class="fdcl_image_profile">
                                    @else
                                        <img src="{{ URL::asset('uploads/maleandfemale.jpg')}}" class="fdcl_image_profile">
                                    @endif
                            </center>
                    ...
                    @if($profile!=""&&Auth::user()->type=="student")
                        <div class="fdcl_content_profile">
                            ...
                            <div class="tab-content widget-content">
                              ...
                              <div class="col-sm-10">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="span2"><b>Religion :</b> {{$profile->religion}}</div>
                                    <div class="span2"><b>Gender :</b> {{$profile->gender}}</div>
                                    <div class="span2"><b>Department :</b> {{$profile->department}}</div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="span3"><b>Mobile 1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> {{$profile->teacher_mobile1}}</div>
                            ...
                            <br/><br/>
                            <?php $classtosection = StudentToSection::where('student_idstudentinfo','=',$profile->idstudentinfo)->orderBy('year','DESC')->get();?>
                            <div class="tab-content widget-content">
                                ...
                                @foreach($classtosection as $ac)
                                    ...
                                    <div class="col-sm-12">
                                        <div class="span3"><b>Roll :</b> {{$ac->year}} </div>
