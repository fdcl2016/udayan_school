                        ...
                        <div class="row">
                            ...
                            <div class="span6">
                                <div class="widget">
                                    ...
                                    <!-- /widget-header -->
                                    {{ Form::open(array('url'=>'/create_student', 'class'=>'form-signup','files' => true)) }}
                                    <div class="widget-content">
                                        <table width="100%">
                                            <tr>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td rowspan="4" align="center">
                                                    <img id="uploadPhoto1" src="../image/downloadPage.jpg"
                                                         style="border-radius:20%; width: 120px; height: 130px; border:5px solid #CCC;">

                                                </td>
                                                <td rowspan="4" align="center">
                                                    <img id="uploadPhoto2" src="../image/downloadPage.jpg"
                                                         style="border-radius:20%; width: 120px; height: 130px; border:5px solid #CCC;">
