...
<br/>
        ...
        <div style="width: 960px;float: left;margin-left: 12px;margin-top: 40px">
            ...
            <table style="border-collapse: collapse;letter-spacing: 1px;width: 100%;" border="1" >
                ...
                <tr>
                    <td>&nbsp;&nbsp;Letter Grade</td><td style="text-align: center">{{$st_rank->grade}}</td><td rowspan="2" style="text-align: center">{{$st_rank->rank}}</td><td style="text-align: center">Attendance</td><td style="text-align: center">N/A</td>
