...
class ResultController extends BaseController {
   ...
   /* function is_type_exist($mark_conf, $type)
    ...
    public function ShohagModifiedConfCT($configuration_name, $ht , $st_id, $term, $idsub, $year, $class)
    {
...
*/
    ...
    public function ShohagModifiedConfMCQ($configuration_name, $mt , $st_id, $term, $idsub, $year, $class)
    {
      ...
      /*  if($configuration_name == "confcls09ict") { $conv_mark = 5; $ct_total=20; $mcq_mark =15; $configuration_total = 50;}
        ...
        $mt_conf = MarksConfiguration::where('configuration_name','=',$configuration_name)->where('configuration_type','=',"MT")->first();
        $ct_conf = MarksConfiguration::where('configuration_name','=',$configuration_name)->where('configuration_type','=',"CT")->orderby('exam_name')->get();
     ...
     public function ShohagModifiedConfCTOnly($configuration_name, $ct1 , $ct2, $ct3)
    {
        $conv_mark = 0; $configuration_total = 100;
       /* if($configuration_name == "confcls09ict") { $conv_mark = 5; $ct_total=40; $ht_mark =20; $configuration_total = 50;}
        if( $configuration_name == "confcls09phy") { $conv_mark = 10; $ct_total=35; $ht_mark =40; }
...
*/
    ...
    public function ShohagModifiedConfMCQOnly($configuration_name, $ct1,$ct2)
    {
        $conv_mark = 0; $configuration_total = 100;
      /*  if($configuration_name == "confcls09ict") { $conv_mark = 5; $ct_total=20; $mcq_mark =15; $configuration_total = 50;}
        if( $configuration_name == "confcls09phy") { $conv_mark = 10; $ct_total=35; $mcq_mark =35; }
...
//        $lists =  MarksConfiguration::where('configuration_name','=',$configuration_name)->get();
    ...
    public function regular_assesment2()
    {
        ...
        $configuration_name = Input::get('configuration_name');
        $sub_mark_range = TotalMarksConfiguration::where('configuration_type','=', $configuration_name)->pluck('total');
        ...
        $sc= count($stdcount);
        $cls_val = Addclass::where('class_name','=',$clsname)->where('section','=',$secname)->pluck('value');
        $cls_id  = Addclass::where('class_name','=',$clsname)->where('section','=',$secname)->pluck('class_id');
        // return $course;
        ...
        if($type=="RT") {
            ...
            $tabuExist = TabulationSheetEditable::where('courseteacher_idcourseteacher','=',$course->idcourseteacher)->where('exam_type','=','RT')->where('term','=',$term)->where('academic_year','=',Input::get('year'))->get();
            if(!count($tabuExist)) {
            ...
            for ($i = 1; $i <= $sc; $i++) {
                ...
                if ($idstudentinfo != null) {
                    ...
                    $editable = TabulationSheetEditable::where('courseteacher_idcourseteacher','=',$course->idcourseteacher)->where('flag','=',"editable")->where('exam_type','=','RT')->where('term','=',$term)->where('academic_year','=',Input::get('year'))->get();
                    if(count($editable)) {
                        if ($exist != null) {
        ...
        if($type=="CT") {
            ...
            $tabuExist = TabulationSheetEditable::where('courseteacher_idcourseteacher','=',$course->idcourseteacher)->where('exam_type','=','CT')->where('term','=',$term)->where('academic_year','=',Input::get('year'))->get();
            if(!count($tabuExist)) {
                $tabulation = new TabulationSheetEditable();
                $tabulation->idcourseteacher = $classteacher->idteacherinfo;
                $tabulation->flag = "editable";
            ...
            for ($i = 1; $i <= $sc; $i++) {
                ...
                if($cls_val > 8) $conv_mark = 0; else $conv_mark = $totalct1 + $totalct2 + $totalct3 + $totalct4;
                ...
                if ($idstudentinfo != null) {
                    ...
                    $editable = TabulationSheetEditable::where('courseteacher_idcourseteacher','=',$course->idcourseteacher)->where('flag','=',"editable")->where('exam_type','=','CT')->where('term','=',$term)->where('academic_year','=',Input::get('year'))->get();
                    ...
                    if(count($editable)) {
                        ...
                        if (count($exist)) {
                            if ($class_Test_11 != "" ||  $class_Test_21 != "" || $class_Test_31 != "" || $class_Test_41 != "") { //return $class_Test_11.$class_Test_21;
                                ...
                                $data['academic_year'] = Input::get('year');
                                $data['converted_marks'] = $conv_mark;
                                $data['last_update'] = Carbon\Carbon::now('+6');
                    ...
                    if($cls_val > 8)
                    {
                        $pass_chk_mcq =0; $pass_chk_lt =0;
                        if($class_Test_11 == null) $class_Test_11= 0; if($class_Test_21 == null) $class_Test_21 = 0;
                        if($class_Test_31 == null) $class_Test_31= 0; if($class_Test_41 == null) $class_Test_41= 0;

                        $ct_cq_conv_mark = ResultController::ShohagModifiedConfCTOnly($configuration_name,$class_Test_11,$class_Test_21,$class_Test_31);
                        $ct_mcq_conv_mark = ResultController::ShohagModifiedConfMCQOnly($configuration_name,$class_Test_21,$class_Test_41);



                        $exist_conv = ConvertedMarks::where('st_id','=',$idstudentinfo)->where('subjectid','=',$idsubject)->where('term','=',$term)->where('class_id','=',$cls_id)->where('year','=',$acayear)->first();

                       // if ($idstudentinfo == "2016911501") return "ct Marks: ".$class_Test_11.','. $class_Test_21 .','. $class_Test_31 .','. $class_Test_41." Conv mark".$ct_cq_conv_mark." MCQ Mark: ".$ct_mcq_conv_mark." exist".$exist_conv;
                        if(count($exist_conv))
                        {
                            $res_conv['cq_ct'] = $ct_cq_conv_mark;
                            $res_conv['mcq_ct'] = $ct_mcq_conv_mark;
                            ConvertedMarks::where('st_id','=',$idstudentinfo)->where('subjectid','=',$idsubject)->where('term','=',$term)->where('class_id','=',$cls_id)->where('year','=',$acayear)->update($res_conv);

                            $totalht = ResultController::ShohagModifiedConfCT($configuration_name, $exist_conv->cq_total, $idstudentinfo, $term, $idsubject, $acayear,$cls_id);
                            $totalmcq = ResultController::ShohagModifiedConfMCQ($configuration_name, $exist_conv->mcq_total, $idstudentinfo, $term, $idsubject, $acayear,$cls_id);

                            $pass_chk_ht = ResultController::is_pass($configuration_name, "HT", $totalht);
                            $pass_chk_mcq = ResultController::is_pass($configuration_name,"MT",$totalmcq);
                            $pass_chk_lt = ResultController::is_pass($configuration_name,"LT",$exist_conv->practical);
                            $total_got_mork = $totalht + $totalmcq + $exist_conv->practical;

                            $grade = ResultController::gradeTotal($cls_val,$total_got_mork,$sub_mark_range);

                            if($pass_chk_ht && $pass_chk_mcq && $pass_chk_lt)
                            {
                            ...
                            $res_conv['cq_ct'] = $ct_cq_conv_mark;
                            $res_conv['cq_conv'] = $totalht;

                            $res_conv['mcq_ct'] = $ct_mcq_conv_mark;
                            $res_conv['mcq_conv'] = $totalmcq;

                            $res_conv['total'] = $total_got_mork;
                            $res_conv['grade'] = $grade_letter;
                            $res_conv['point'] = $grade_point;
                        ...
                        {
                            $res_conv = new ConvertedMarks();
                            $res_conv->st_id = $idstudentinfo;
                            $res_conv->subjectid = $idsubject;
                            $res_conv->class_id = $cls_id;
                            $res_conv->term = $term;
                            $res_conv->year = $acayear;
                            $res_conv->cq_ct = $ct_cq_conv_mark;
                            $res_conv->mcq_ct = $ct_mcq_conv_mark;
                            $res_conv->save();
        ...
        if($type=="HT") {
            $tabuExist = TabulationSheetEditable::where('courseteacher_idcourseteacher','=',$course->idcourseteacher)->where('exam_type','=','HT')->where('term','=',$term)->where('academic_year','=',Input::get('year'))->get();
            ...
            for ($i = 1; $i <= $sc; $i++) {
                ...
                if($Hall_Test1 != null && $cls_val > 8) $spc_ht = ResultController::ShohagModifiedConfCT($configuration_name, $Hall_Test1, $idstudentinfo, $term, $idsubject, $acayear, $idcourseteacher);

                //  if (!isset($Hall_Test1)) $spc_ht =0;
                // $test .= $idstudentinfo."<br> mark = ".$spc_ht."<br>";
                $ht = MarksConfiguration::where('configuration_name', '=', $configuration_name)->where('configuration_type', '=', "HT")->where('exam_name', '=', 'Hall_Test')->first();
                if (count($ht)) {
                    $totalht = ($Hall_Test1 * $ht->converted_marks) / $ht->weighted_marks;
                } else {
                    $totalht = null;
                }
                if($spc_ht) $totalht = $spc_ht;
                ...
                if ($idstudentinfo != null) {
                    ...
                    $editable = TabulationSheetEditable::where('courseteacher_idcourseteacher', '=', $course->idcourseteacher)->where('flag', '=', "editable")->where('exam_type', '=', 'HT')->where('term', '=', $term)->where('academic_year', '=', Input::get('year'))->get();
                    ...
                    if($cls_val > 8)
                    {
                        ...
                        {
                            $pass_chk_ht = ResultController::is_pass($configuration_name, "HT", $totalht);
                            $pass_chk_mcq = ResultController::is_pass($configuration_name,"MT",$exist_conv->mcq_conv);
                            $pass_chk_lt = ResultController::is_pass($configuration_name,"LT",$exist_conv->practical);
                            $total_got_mork = $totalht + $exist_conv->mcq_conv + $exist_conv->practical;
        ...
        if($type=="LT") {
            ...
            $tabuExist = TabulationSheetEditable::where('courseteacher_idcourseteacher', '=', $course->idcourseteacher)->where('exam_type', '=', 'LT')->where('term', '=', $term)->where('academic_year', '=', Input::get('year'))->get();
            ...
            for ($i = 1; $i <= $sc; $i++) {
                ...
                if ($idstudentinfo != null) {
                    ...
                    $editable = TabulationSheetEditable::where('courseteacher_idcourseteacher', '=', $course->idcourseteacher)->where('flag', '=', "editable")->where('exam_type', '=', 'LT')->where('term', '=', $term)->where('academic_year', '=', Input::get('year'))->get();
                    if (count($editable)) {
                        if ($exist != null) {
                    ...
                    if($cls_val > 8)
                    {
                        ...
                        if(count($exist_conv))
                        {
                            $pass_chk_ht = ResultController::is_pass($configuration_name, "HT", $exist_conv->cq_conv);
                            $pass_chk_mcq = ResultController::is_pass($configuration_name,"MT",$exist_conv->mcq_conv);
                            $pass_chk_lt = ResultController::is_pass($configuration_name,"LT",$totalvt + $totalet);
                            $total_got_mork =  $exist_conv->cq_conv + $exist_conv->mcq_conv + $totalvt + $totalet;
                            ...
                            $res_conv['practical'] = $totalvt + $totalet;
        ...
        if($type=="MT") {
            ...
            $tabuExist = TabulationSheetEditable::where('courseteacher_idcourseteacher','=',$course->idcourseteacher)->where('exam_type','=','MT')->where('term','=',$term)->where('academic_year','=',Input::get('year'))->get();
            ...
            for ($i = 1; $i <= $sc; $i++) {
                ...
                if($MCQ_Test1 != null && $cls_val > 8) $spc_mt = ResultController::ShohagModifiedConfMCQ($configuration_name, $MCQ_Test1, $idstudentinfo, $term, $idsubject, $acayear, $idcourseteacher, $course->idcourseteacher);


                $mt = MarksConfiguration::where('configuration_name','=',$configuration_name)->where('configuration_type','=',"MT")->where('exam_name','=','MCQ_Test')->first();
                if(count($mt))
                {
                ...
                if ($idstudentinfo != null) {
                    ...
                    $editable = TabulationSheetEditable::where('courseteacher_idcourseteacher','=',$course->idcourseteacher)->where('flag','=',"editable")->where('exam_type','=','MT')->where('term','=',$term)->where('academic_year','=',Input::get('year'))->get();
                    ...
                    if($cls_val > 8)
                    {
                        ...
                        {
                            $pass_chk_ht = ResultController::is_pass($configuration_name, "HT", $exist_conv->cq_conv);
                            $pass_chk_mcq = ResultController::is_pass($configuration_name,"MT", $totalmt);
                            $pass_chk_lt = ResultController::is_pass($configuration_name,"LT",$exist_conv->practical);
                            $total_got_mork = $totalmt + $exist_conv->cq_conv + $exist_conv->practical;
                            ...
                            $res_conv['mcq_total'] = $MCQ_Test1;
                            $res_conv['mcq_conv'] = $totalmt;
                        ...
                        else
                        {
                            ...
                            $res_conv->term = $term;
                            $res_conv->year = $acayear;
                            $res_conv->cq_total = $MCQ_Test1;
                            $res_conv->cq_conv = $totalmt;
                            $res_conv->save();
    ...
    public function resultindividual()
    {
        ...
        if($subject!=null&&$subject!="")
        {
            ...
            {
                return View::make('result_management.student_result')->with('subject',$subject)->with('idclass',$addclass3->class_id)->with('subject2',$subject2)->with('idclass2',$idclass)->with('class',$class);
            }
            else{
