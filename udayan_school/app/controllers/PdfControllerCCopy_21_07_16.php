...
<img src = "../public/uploads/'."2016911101".'.png" width = "80" height = "90" >
 ...
 $res = ConvertedMarks::where('st_id',$s->student_idstudentinfo)->where('year',$year)->where('term',$term)
          ...
          $html.='<tr style="text-align: center ;font-family:arial;font-size:26px">
                    <td width="300px" style="text-align: left;font-size: 24px"><b>'.$result->subject_name.'</b></td>
                    <td width="60px" style="font-size:26px;text-align:center"> '.$tot.'</td>
                        <td width="110px" style="font-size:26px;text-align:center">'.$result->cq_conv.'</td><td style="font-size:26px;text-align:center" width="107px">'.$result->mcq_conv.'</td><td width="110px" style="font-size:26px;text-align:center">'.$result->practical.'</td>
...
<div style="width: 960px;float: left;margin-left: 12px;margin-top: 15px"><table style="border-collapse: collapse;letter-spacing: 1px;width: 100%;" border="1" >
            ...
            <td>&nbsp;&nbsp;Grade Point Average (GPA</b>)</td><td style="text-align: center">'.$grp.'</td>
