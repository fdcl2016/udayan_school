    ...
    <div class="span6">
        ...
        <div class="widget-content">
            <div class="shortcuts">
                ...
                $c = count($ct);
                ?>
                {{--@if($c>0 || $ct11->idclasssection == 50 || $ct11->idclasssection == 51 || $ct11->idclasssection == 52 || $ct11->idclasssection == 53 || $ct11->idclasssection == 54 || $ct11->idclasssection == 55 || $ct11->idclasssection == 56)--}}
...
$notice = Notice::where('notice_type','Teachers')->orwhere('notice_type','Public')->OrderBy('idnotice','desc')->take(5)->get();?>
