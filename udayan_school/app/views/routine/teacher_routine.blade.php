        ...
        <div class="widget ">
            ...
            <div class="widget-content">
                        ...
                        @foreach($idconfiguration as $config_id)
                            ...
                            //                            $routine = TeacherRoutine::where('idteacherinfo', '=', Auth::user()->user_id)
                            //                                    ->where('configuration_id', '=',$config_id->idconfiguration )
                            //                                    ->get();
                            $routine = Techrout::where('idteacherinfo', '=', Auth::user()->user_id)
                                    ->where('configuration_id', '=',$config_id->idconfiguration )->orderBy('value')
                                    ->get();
                                ...
                                <div class="col-sm-12" >
                                    <div class="table-responsive">
                                        <h4>Shift:
                                            ...
                                            @if($routine_confuguration->shift== 'Morning')

                                                {{"Morning (8 am - 11:59 am)"}} {{"And  Afternoon (After 12pm)"}}
                                            @elseif($routine_confuguration->shift== 'Day')

                                                {{"Afternoon (After 12pm)"}}
                                            @endif

                                        </h4></br>
                                        <table class="table table-bordered table-responsive table-hover" style="overflow-x: auto; display: block">
                                            <thead>
                                            <tr>
