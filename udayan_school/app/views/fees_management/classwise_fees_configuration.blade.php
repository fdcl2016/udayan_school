...
@section('content')
    ...
    <div class="alert alert-info" style="border-left: 5px solid #33D685;"><strong><h3
                                    style="color:black">Class Wise Fees Configuration</h3></strong></div>
                    <div id="stdregister_div"></div>
 
{{Form::open(array('url'=>'/classwiseconfiguration', 'class'=>'form-inline','name'=>'myForm',
...
<div class="control-group col-sm-3">
  ...
  <div class="controls">
    <select name="sub" id="sub"  class="form-control" style="width:160px" required>
    </select>
  </div> <!-- /controls -->
</div>
 ...
 $("#class_name").on('change',function (e) {
  ...
  // document.write('hello');
   ...
   //  document.write(cat_id);
      $.get('<?php echo Config::get('baseurl.url');?>/ajaxfees?cat_id=' +cat_id,function(data) {
//console.log(data);
        $('#sub').empty();
