...
<?php $i=0; ?>
                                    @if(count($results) || count($conv_marks)) <?php
                                                      ...
                                                      @if($mcq==1)
                                                          <td align="center">
                                                              ...
                                                              <table  style="text-align: center;border-collapse: collapse">
                                                                  ...
                                                                  <tr>
                                                                      @if(isset($result->mcq_total))<td style="">{{$result->mcq_ct}}</td><td style="">{{$result->mcq_total}}</td><td style="">{{$result->mcq_conv}}</td>
@else
<td style="">N/A</td><td style="">N/A</td><td style="">N/A</td>@endif
                                                      ...
                                                      <td style=" text-align: center;">{{sprintf("%.2f",$result->point)}}</td>
