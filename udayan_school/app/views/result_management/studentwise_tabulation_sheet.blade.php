                   ...
                   <li>
                    ...
                    <div class="tab-content">
                        <div class="alert alert-info" style="border-left: 5px solid #33D685;"><strong><h3
                                        style="color:black">Student wise Tabulation Sheet</h3></strong></div><br/>
                                        <?php $stu = Studentinfo::where('idstudentinfo','=',$result->st_id)->first(); ?>
                                ...
                                <div class="table-responsive" style="padding-left:1%;padding-right:1%">
                                    ...
                                    <div class="widget-header">
                                    <div style="padding-left: 20px; margin-left: 20 px;"> Student Name:  <b>{{$stu->sutdent_name}}</b> &nbsp;&nbsp;&nbsp;&nbsp; Student Roll:  <b>{{$stu->student_roll}}</b></div>
                                     </div>
<br>
                                        <table cellspacing="0" width="100%" border="0" style="border-collapse: collapse">
                                            ...
                                            <thead>
                                            <tr>
                                                <th><div></div></th> <th colspan="5"><div style="float: left; width: 33%;">Class:&nbsp; {{$result->class}}</div>
                                                    <div style="display: inline-block; width: 25%;">Section:&nbsp;{{$result->section}}</div></th>
                                        ...
                                        <br/>
                                        <div style="border:1px solid gray;width:auto; height: 500px;  overflow-y:scroll;overflow-x:scroll;">
                                        <table border="1" cellspacing="0"  border="1" style="border-collapse: collapse">

                                            <tr>
                                            <th rowspan="2" style=" padding-left: 10px;padding-right:10px"><b>Serial</b></th>
                                                <th rowspan="2" style="padding-left: 10px;"><b>Subject Name</b></th>
                                                  <?php //$std_no = count($students); $sub_no = (count($stu_results))/$std_no;  ?>

                                                    <th  bgcolor="<?php echo "#".rand(111111,999999); ?>" style="color: white; width: 360px; text-align: center">{{"All subject"}}</th>
                                                            ...
                                                            <td width="320px">
                                                                <table style="background-color: #19bc9c">
                                                                    <th style="text-align: center; border-left: 1px solid black; border-right: 1px solid black;" colspan="8">Half Yearly</th>
                                                                        <tr>
                                                                            <td  style="text-align: center; width: 40px; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;"><b>CT</b></td>
                                                                            <td  style="text-align: center; width: 40px; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;"><b>RA</b></td>
                                                                            <td  style= "text-align: center; width: 40px; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;"><b>MCQ</b></td>
                                                                            <td  style="text-align: center; width: 40px; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;"><b>LAB</b></td>
                                                                            <td  style="text-align: center; width: 40px; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;"><b>HT</b></td>
                                                                            <td  style= "text-align: center; width: 40px; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;"><b>Total</b></td>
                                                                            <td  style="text-align: center; width: 40px; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;"><b>Grade</b></td>
                                                                            <td  style="text-align: center; width: 40px; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;"><b>Point</b></td>
                                                                        </tr>
                                                                  </table>
                                                             </td>
                                            ...
                                            </tr><?php $cnt = 1; //echo count($stu_results);  ?>
                                            ...
                                            <?php //$std = $i*$sub_no; $final_mark=0; $finalgp = 0;
                                             ...
                                             //$student_id = $student->S_ID;  $i=0; ?>
                                                <tr>
                                                    <td style=" padding-left: 10px;"><b>{{$cnt++}}</b></td>
                                                    <td style=" padding-left: 10px;"><b>{{$result->subject}}</b></td>
