...
<li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="fdcl_content_profile">
                            ...
                            <div class="widget-content">
                                {{Form::open(array('url'=>'/tabulationsheet_all', 'class'=>'form-inline')) }}
                                <div class="col-sm-3">
                                                 ...
                                                 ?>
                                                            <td >
                                                                <table border="0" style=" table-layout: fixed;width: 250px;height:50px" style="border-collapse:collapse ">
                                                                    <tr>
                                                                    @if($rt)
                                                                    <td align="center" style="border-right: 1px solid black;">{{$ra_marks}}</td>
                                                                    @endif

                                                                    @if($lt)
                                                                    <td align="center" style="border-right: 1px solid black;">{{$lab_marks}}</td>
                                                                    @endif

                                                                    @if($ct)
                                                                    <td align="center" style="border-right: 1px solid black;">{{$ct_marks}}</td>
                                                                    @endif

                                                                    @if($ht)
                                                                    <td align="center" style=" border-right: 1px solid black;">{{$ht_marks}}</td>
                                                                    @endif

                                                                    @if($mcq)
                                                                    <td align="center" style=" ">{{$mcq_marks}}</td>
                                                                    @endif
                                                                        ...
                                                                        if($rcls != "Nine" && $rcls != "Ten")
                                                                         ...
                                                                         if($total < ($rtotal/2))
                                                                          ...
                                                                          ?>
                                                                            ...
                                                                            <td align="center" style="border-left: 1px solid black;"><b>{{$total}}</b></td>
                                                                            <td align="center" style="border-left: 1px solid black;"><b>{{$grade_l}}</b></td>
                                                                            <td align="center" style="border-left: 1px solid black;"><b>{{$grade_p}}</b></td>
