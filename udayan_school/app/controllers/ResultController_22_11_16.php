...
*/
 ...
 $st_rslt_ct = ResultClassTest::where('studentinfo_idstudentinfo', $student_info->student_idstudentinfo)->where('class', $class_name)->where('section', $class_sec)->where('idclasssection', $class_section_id)->where('idsubject', $subject_id)->where('term', $term)->where('academic_year', $year)->first();
...
*/
     ...
     $st_rslt_ht = ResultHallTest::where('studentinfo_idstudentinfo', $student_info->student_idstudentinfo)->where('class', $class_name)->where('section', $class_sec)->where('idclasssection', $class_section_id)->where('idsubject', $subject_id)->where('term', $term)->where('academic_year', $year)->first();
