...
/* Current Year and Annual Term */
$current_year = Date("Y");
$current_term = ($term == "Final" ? "Annual" : $term);
...
if(count($students)){
    ...
    <div style="width:auto;float: left;text-align: center;margin-right:90px;margin-top:12px" >
        <p style="font-size: 22px;margin-top:20px;font-weight: bold;color:#000066">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img style="margin-top:-40px"  src="../public/image/4d.gif"width="80" height="50" >&nbsp;<span style="font-size: 22px">'. Config::get('schoolname.school') .'</span><br/><span style="text-align:center">University Of Dhaka</span></p>
          <p style="font-size:18px" >
<b style="text-align:center">&nbsp;&nbsp;&nbsp;&nbsp;<u>TABULATION SHEET OF CLASS '."$class"."(".$section.")". '; &nbsp;&nbsp;'.$current_term.' Exam&nbsp;- '.$current_year.'</u></b>
        </p>
...
<table   border="1" cellspacing="1"  style="border-collapse: collapse;">
    ...
    $html.='<td><table border="1" style="width: 700px;table-layout: fixed;border-collapse: collapse;font-size: 20px;text-align: center"><tr><td STYLE="font-size: 20px;width: 100px;text-align: center;">'.$half_total.'</td>';
    
    $html.='<td STYLE="font-size: 20px;width: 100px;text-align: center;">'.$final_total.'</td>';
    
    $html.='<td STYLE="font-size: 20px;width: 100px;text-align: center;">'.($half_total + $final_total).'</td>';
    ...
    if($fail_count>0){
            ...
            $html.='<td style="font-size: 20px;width: 100px;text-align: center">'."0".'</td>';
              ...
              <div style="width: 100%; text-align: center;font-weight: bold"><br/>Total Student:'.$std_no.' , Number of Failed Student: '.($std_no - $num_st_pass).', Number of Passed Student: '.$num_st_pass.'</div>
                                        ...
                                        <div style="position: relative; margin: auto; top: 0; right: 0; bottom: 0; left: 0; width: 850px;">
                                            ...
                                            <table style="table-layout: fixed; width: 100%;" >
                                                <tr>
                                                    <td width="50px">
                                                        <img src="./image/grade_8.png" height="70px"/>
                                                    </td>
...
$val = $class.'_'.$section.'_tbsheet.pdf';
