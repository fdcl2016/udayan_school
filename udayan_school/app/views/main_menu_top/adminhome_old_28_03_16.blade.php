    ...
    <div class="span6">
        <div class="widget">
            ...
            <div class="widget-content">
                <div class="shortcuts">
                    <a href="{{ URL::to('/student_management/addstudent')}}" class="shortcut"><i class="shortcut-icon icon-user"></i><span class="shortcut-label">Student Admission</span> </a>
                    <a href="{{ URL::to('/staff_management/addteacher')}}" class="shortcut"><i class="shortcut-icon icon-user"></i><span class="shortcut-label">Teachers' Information</span> </a>
                    <a href="{{ URL::to('/classroom_management/assign_teacher_to_section')}}" class="shortcut"><i class="shortcut-icon icon-hdd"></i> <span class="shortcut-label">ClassRoom  Management</span> </a>
                    <a href="{{ URL::to('/subject_management/create_subject')}}" class="shortcut"><i class="shortcut-icon icon-book"></i> <span class="shortcut-label">Subject  Management</span> </a>
                    <a href="{{ URL::to('/fees_management/fees_configuration')}}" class="shortcut"><i class="shortcut-icon icon-dollar"></i><span class="shortcut-label">Fees  &nbsp;&nbsp;&nbsp;&nbsp;Management</span> </a>
                    <a href="{{ URL::to('/holiday_management/create_events')}}" class="shortcut"><i class="shortcut-icon icon-list-alt"></i><span class="shortcut-label">Holiday Management</span> </a>
                    ...
                    <a href="{{ URL::to('/reports/report')}}" class="shortcut"><i class="shortcut-icon icon-search"></i> <span class="shortcut-label">Institutional Reports </span> </a>
...
<br/>
            <div class="widget widget-nopad">
                ...
                <div class="widget-content">
                    <ul class="news-items">
                        <?php $notice = Notice::OrderBy('idnotice','desc')->take(5)->get();?>
 ...
 <br/>
                      <center><a href="{{URL::to('/notice_management/show_notice')}}"><button class="btn btn-success">Show All </button></a></center>
