...
foreach($st as $s ){
    ...
    $html.='<tr><td style="text-align: center;font-size: 20px;width:40px">'.$s->st_roll.'</td><td style="font-size: 20px;width: 200px">'.$s->sutdent_name.$s->sutdent_name.'</td>';
...
<table   border="" cellspacing="1"  style="border-collapse: collapse;">
    ...
    $html.='<td style="font-size: 20px;width: 100px;text-align: center"></td>';
