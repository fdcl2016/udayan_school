                    ...
                    <div class="widget widget-nopad">
                        ...
                        <div class="widget-content" style="overflow-x: auto">
                            <div>
                                ...
                                $attendance=AttendanceSheet::where('studentinfo_idstudentinfo','=',Auth::user()->email)
...
$cp = null; $ca =null;
                                ...
                                <div class="form-group col-sm-12">
                                    {{ Form::open(array('url'=>'/attendance_management/att','class'=>'form-horizontal')) }}
                                    <div class="col-sm-6">
                                                        ...
                                                        @if($counter>=$space_day)
                                                            ...
                                                            @if($count_day<=$days_in_month)
                                                                @if ($date[$count_day1]=="yes")
                                                                    ...
                                                                    @endif
                                                                @elseif ($holy11==$holy2 || $holy1==$holy2 )
                                                                    <?php  $id = "summery" . $counter;
