 ...
 <div style="width:auto;float: left;margin-left: 12px">
        ...
        <table >
            ...
            <tr>
                ...
                <td height="25"><b>Version :</b> &nbsp;BANGLA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b> Year : '."2016".'</b></td>
    ...
    <div style="width: 150px;float: right;margin-left: 5px;position:relative;margin-top: -180px;margin-bottom: 20px">
        <img src="../public/image/grade_8.png" width="150" height="210">
    </div>
    </div>
        ...
        <table  style="border-collapse: collapse;letter-spacing: 1px;width: 100%;font:arial" border="1" >
            ...
            <tr style="text-align: center" >
                <th width="300px" style="font-size: 24px"><b>Subject Name</b></th>
                 <th width="80px" style="font-size: 24px"><b>Full Marks</b></th>
                 <th width="80px" style="font-size: 22px">Half Yearly</th>
                ...
                <th width="320px" style="font-size: 24px" colspan="4">
                    ...
                    <table style="border-collapse: collapse;text-align: center;font-size: 22px;letter-spacing: 1px;width: 100%;" border="1">
                        ...
                        <tr>
                            ...
                            <th width="80px">MCQ</th>
                            <th width="80px">CQ</th>
                            <th width="80px">Practical</th>
                ...
                <th width="80px" style="font-size: 22px">Grand Total</th>
...
$fail_check =0;
            ...
            $fail_check =0;
                     ...
                     foreach ($res as $result) {
                     	...
                     	$subtot = Subtot::where('class',$cls)->where('idsubject',$result->subjectid)->pluck('gt_total');
            ...
            <td width="80px" style="font-size:18px;text-align:center">'.$subtot.'</td>
        <td style="font-size:18px;text-align:center" width="80px">'.$result->h_total.'</td>

         <td width="80px" style="font-size:18px;text-align:center">'.$result->f_mcq.'</td>
         <td width="80px" style="font-size:18px;text-align:center">'.$result->f_ht.'</td>
         <td width="80px" style="font-size:18px;text-align:center">'.$result->f_lab.'</td>
         <td width="80px" style="font-size:18px;text-align:center">'.$result->f_total.'</td>
 ...
 ';
     ...
     /********************************************* FOR RELIGION *******************************************/
            ...
            $html.='<tr style="text-align: center">
                <td colspan="7" style="text-align: center;font-weight: bold;font-size: 23px"> Total Marks And Total Grade Point</td>
