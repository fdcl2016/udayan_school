...
class ResultController extends BaseController {
    ...
    public function ShohagModifiedConfCT($configuration_name, $ht , $st_id, $term, $idsub, $year, $class, $courseteacher)
    {
        ...
        if (isset($ct->ct1) && isset($ct->ct3))

        { $ct1 = $ct->ct1; $ct2 = $ct->ct3; }
        ...
        return round($ht_conv_given_mark);
        /*
    ...
    public function ShohagModifiedConfMCQ($configuration_name, $mt , $st_id, $term, $idsub, $year, $class, $courseteacher)
    {
        ...
        if(!$conv_mark) return 0;
        $ct = ResultClassTest::where('studentinfo_idstudentinfo','=',$st_id)->where('idsubject','=',$idsub)->where('idclasssection','=',$class)->where('term','=',$term)->where('academic_year','=',$year)->first();
        if (isset($ct->ct2) && isset($ct->ct4))

        { $ct1 = $ct->ct2; $ct2 = $ct->ct4; }
        ...
        return round($mt_conv_given_mark);
    ...
    public function regular_assesment2()
    {
        ...
        if($type=="HT") {
            ...
            for ($i = 1; $i <= $sc; $i++) {
                ...
                if($Hall_Test1 != null) $spc_ht = ResultController::ShohagModifiedConfCT($configuration_name, $Hall_Test1, $idstudentinfo, $term, $idsubject, $acayear, $idcourseteacher, $course->idcourseteacher);
        ...
        if($type=="MT") {
            ...
            for ($i = 1; $i <= $sc; $i++) {
                ...
                if($MCQ_Test1 != null) $spc_mt = ResultController::ShohagModifiedConfMCQ($configuration_name, $MCQ_Test1, $idstudentinfo, $term, $idsubject, $acayear, $idcourseteacher, $course->idcourseteacher);
    ...
    public function submit_mark()
    {
        ...
        if(count($students)) {
            ...
            for ($i = 0; $i < $std_no; $i++) {
                ...
                $student_marks->class = $class;
                $student_marks->section = $section;
                $student_marks->term = $term;
                $student_marks->year = $year;
