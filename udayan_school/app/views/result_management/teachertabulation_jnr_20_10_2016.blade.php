...
<b style="text-align:center">&nbsp;&nbsp;&nbsp;&nbsp;<u>TABULATION SHEET OF CLASS '.$class."(".$section.")". '; &nbsp;&nbsp;'.$term.' Exam&nbsp;-'.$year.'</u></b>
                                        ...
                                        <table border="1" cellspacing="0"  border="1" style="border-collapse: collapse">
                                            ...
                                            <tr>
                                                <th rowspan="2" style=" padding-left: 5px;padding-right:10px;font-size: 18px;width:100px"><b>Roll</b></th>
                                                <th  rowspan="2"  style=" padding-left: 6px;font-size: 18px;width:80px"><b>Student Name</b></th>';
...
foreach($subname as $s){
 ...
 <table   border="1" cellspacing="1"  style="border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="text-align: center;font-size: 18px;" width="60px">Half Yearly</td><td style="text-align: center;font-size: 18px;" width="60px">Final</td><td style="text-align: center;font-size: 18px;" width="60px">Grand Total</td>
                                <td align="center" style="text-align: center;font-size: 18px;" width="60px"><b>Grade</b></td><td align="center" style="text-align: center;font-size: 18px;" width="60px"><b>GPA</b></td>
                            </tr>
...
$html.=' <td>
    <table border="1" style=" table-layout: fixed;width: 250px;" style="border-collapse: collapse">
        <tr>
            ...
            <td align="center" style=" border-left: 1px solid black;font-size: 20px;width: 100px"><b>Grand Total</b></td>
...
foreach($st as $s ){
    ...
    $html.='<tr><td style="text-align: center;font-size: 20px;width:40px">'.$s->st_roll.'</td><td style="font-size: 20px;width: 400px">'.$s->sutdent_name.'</td>';
...
<table   border="1" cellspacing="1"  style="border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="text-align: center;font-size:16px;" width="60px">'.$re->h_total.'</td><td style="text-align: center;font-size: 16px;" width="60px">'.$re->f_total.'</td><td style="text-align: center;font-size: 16px;" width="60px">'.$re->gt_total.'</td>';
                                
                              if($re->gt_grade=='F')
                            {
                                $html.='<td style="text-align: center;font-size: 16px;color:red;font-weight:bold" width="60px">'.$re->gt_grade.'</td>';
        
        $fail_count++;
        
                              } else{
            
                             $html.='<td style="text-align: center;font-size: 16px;" width="60px">'.$re->gt_grade.'</td>';
                              }
            
        
        $html.='<td style="text-align: center;font-size: 16px;" width="60px">'.$re->gt_gp.'</td>';
    ...
    $html.='<td><table border="1" style="width: 100px;border-collapse: collapse;font-size: 20px;text-align: center"><tr><td>'.$sum_total.'</td>';
    ...
    $html.='<td style="font-size: 20px;width: 100px;text-align: center">'.$point_avg.'</td>';
