            ...
            foreach($mark_config as $config) {
                if ($config->configuration_type == "RT") { // Regular assessment
                    ...
                    if(!(($class_num == 5 || $class_num == 8 || $class_num == 10) && strtolower($term) == 'final'))
                    {
                        ...
                        $st_rslt_ct = ResultClassTest::where('studentinfo_idstudentinfo', $student_info->student_idstudentinfo)->where('class', $class_name)->where('section', $class_sec)->where('idclasssection', $class_section_id)
...
->where('idsubject', $subject_id)->where('term', $term)->where('academic_year', $year)->first();
                    ...
                    if ($class_num > 8) {
                        ...
                        if (!(($class_num == 10) && (strtolower($term) == 'final'))) {
                            ...
                            //$tmp['ct_mcq'] = 0;
                            if($class_num == 11 && $pass_flag == true) { //total mcq mark check
                    ...
                    if($class_num > 8) {
                        ...
                        if (!(($class_num == 10) && (strtolower($term) == 'final'))) {
                            ...
                            if(($class_num == 11 || $class_num == 12) && $pass_flag == true) { 
                                
                                if(($config->ct_type!='2' || $config->ct_type!=2) && $pass_flag == true ){
                ...
                */
                ...
                if($class_num < 11) {
                    ...
                    if(strtolower($term) == 'final')
                    {
                    	...
                    	if($pass_flag || $pass_flag ==1) {
                            
                           // echo  $class_num."<br/>". $conv_res['total']."<br/>". $half_total;
                          ...
                          // echo $conv_grade['letter']."<br/>".$conv_grade['point'];
